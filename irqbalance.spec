...
Source0  : https://github.com/Irqbalance/irqbalance/archive/v1.8.0/irqbalance-1.8.0.tar.gz
...
%prep
%setup -q -n irqbalance-1.8.0
cd %{_builddir}/irqbalance-1.8.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618325573
...
cp %{_builddir}/irqbalance-1.8.0/COPYING %{buildroot}/usr/share/package-licenses/irqbalance/dfac199a7539a404407098a2541b9482279f690d
%make_install
